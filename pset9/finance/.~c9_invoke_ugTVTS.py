...
def quote():
    if request.method == "POST":
        ...
        return render_template("quoted.html", new_stock = {'name':stock['name'],'symbol':stock['symbol'],'price':(stock['price'])})
...
def register():
    ...
    if request.method == "POST":
        ...
        CON_PASS = request.form.get("confirm password")
        if not CON_PASS:
        ...
        try:
            ...
            return apology("Username already existed.Try Another.",403)
